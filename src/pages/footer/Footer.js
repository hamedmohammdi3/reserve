...
const Footer = () => {
    ...
    useEffect(() => {
        ...
        return (
        <div className={hasScrollBar ? 'footer container-fluid bg-dark text-light pt-5 mt-5 wow fadeIn' : ' footerFix container-fluid bg-dark text-light  pt-5 mt-5 wow fadeIn'} data-wow-delay="0.1s">
